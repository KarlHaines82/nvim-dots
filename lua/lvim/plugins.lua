...
local core_plugins = {
	...
	{ "nvim-lua/plenary.nvim", cmd = { "PlenaryBustedFile", "PlenaryBustedDirectory" }, lazy = false },
	-- Telescope
	{
	...
	{ "rafamadriz/friendly-snippets", lazy = false, cond = lvim.builtin.luasnip.sources.friendly_snippets },
	{
		"folke/neodev.nvim",
		lazy = false,
	},
